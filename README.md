...
This model achieved an F1 Score of 0.5604, with an accuracy of 0.58 on the test set. This is quite decent for a baseline model. It seems to get predictions right a little bit more than half of the time, which should be better than an educated guess - there are seven values we can predict.
